...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $cookieValue = $_POST['value'] ?? random_int(1, 100);
...
<body>
    ...
    <form method="post">
        <label for="value">Nouvelle valeur (laissez vide pour une valeur aléatoire entre 1 et 100) :</label>
        <input type="text" name="value" id="value" value="<?= htmlspecialchars($cookie_value) ?>">

<?php
require_once __DIR__ . '/../src/AbstractShape.php';
require_once __DIR__ . '/../src/Rectangle.php';
require_once __DIR__ . '/../src/Circle.php';
require_once __DIR__ . '/../src/Triangle.php';
require_once __DIR__ . '/../utils/analyze-shapes.php';
require_once __DIR__ . '/../utils/draw-shapes.php';
require_once __DIR__ . '/../utils/find-largest-shape.php';

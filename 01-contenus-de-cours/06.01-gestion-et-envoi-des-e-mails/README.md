...
- Autres formes du support de cours :
  [Presentation (web)](https://heig-vd-progserv-course.github.io/heig-vd-progserv2-course/01-contenus-du-cours/06.01-gestion-et-envoi-des-e-mails/index.html)
  ·
  [Presentation (PDF)](https://heig-vd-progserv-course.github.io/heig-vd-progserv2-course/01-contenus-du-cours/06.01-gestion-et-envoi-des-e-mails/06.01-gestion-et-envoi-des-e-mails-presentation.pdf)
...
![Infomaniak - Outils collaboratifs](./_images/infomaniak-outils-collaboratifs.png)

![Infomaniak - Service Mail](./_images/infomaniak-service-mail.png)
...
![Infomaniak - Commander un Service Mail](./_images/infomaniak-commander-service-mail.png)
...
![Infomaniak - Recherche de nom de domaine](./_images/infomaniak-recherche-nom-de-domaine.png)
...
![Infomaniak - Sélection du plan de messagerie](./_images/infomaniak-selection-plan-messagerie.png)

![Infomaniak - Validation de la commande](./_images/infomaniak-validation-commande.png)
...
![Infomaniak - Tableau de bord du service mail](./_images/infomaniak-tableau-de-bord-du-service-mail.png)
...
![Infomaniak - Tableau de bord du service mail lié au nom de domaine](./_images/infomaniak-tableau-de-bord-du-service-mail-lie-au-nom-de-domaine.png)
...
![Infomaniak - Configuration de l'adresse e-mail (1/5)](./_images/infomaniak-configuration-adresse-email-1.png)

![Infomaniak - Configuration de l'adresse e-mail (2/5)](./_images/infomaniak-configuration-adresse-email-2.png)

![Infomaniak - Configuration de l'adresse e-mail (3/5)](./_images/infomaniak-configuration-adresse-email-3.png)

![Infomaniak - Configuration de l'adresse e-mail (4/5)](./_images/infomaniak-configuration-adresse-email-4.png)

![Infomaniak - Configuration de l'adresse e-mail (5/5)](./_images/infomaniak-configuration-adresse-email-5.png)
...
> <summary>Cliquer ici pour voir une capture d'écran illustrant l'étape</summary>
>
> ![Windows - Ouvrir une fenêtre PowerShell ici](./_images/windows-ouvrir-une-fenetre-powershell-ici.png)
>
> </details>
...
![Mailpit - Exécution dans le terminal (1/3)](./_images/mailpit-execution-dans-le-terminal-1.png)

![Mailpit - Exécution dans le terminal (2/3)](./_images/mailpit-execution-dans-le-terminal-2.png)

![Mailpit - Exécution dans le terminal (3/3)](./_images/mailpit-execution-dans-le-terminal-3.png)
...
![Mailpit - Interface web](./_images/mailpit-interface-web.png)
